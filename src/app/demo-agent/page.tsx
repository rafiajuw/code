...
export default function DemoAgent() {
  const [messages, setMessages] = useState([
    { text: "Hi! I'm your Demo Agent. Speak or type to start a live demo!", sender: "ai" },
  ]);
  ...
  const handleSend = (e: React.FormEvent) => {
    e.preventDefault();
    if (input.trim()) {
      setMessages([...messages, { text: input, sender: "user" }, { text: "Running demo... Opening sample app!", sender: "ai" }]);
      setInput("");
      setTimeout(() => {
        setMessages((prev) => [
          ...prev.slice(0, -1),
          { text: `Demo started! I can navigate UI, explain features, and respond to voice. Try 'show dashboard' or 'explain pricing'!`, sender: "ai" },
        ]);
      }, 1000);
    }
  };
